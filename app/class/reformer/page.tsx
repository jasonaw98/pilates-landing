    ...
    <main className="min-h-screen">
      <section className="mt-32">
        <div className="flex flex-col items-center gap-12">
          ...
          <h1 className="text-4xl font-ivy-ora-display md:text-h1">Reformer Pilates</h1>
        </div>
      </section>
      <ClassZoomReveal
        ...
        content={
          <div className="max-w-5xl px-8 text-center text-white flex-col flex justify-between items-center h-full py-20 pt-32">
            <div className="text-2xl md:text-h1 h-full justify-center font-ivy-ora-display break-keep text-center items-center flex flex-col gap-2">
              <p>Build strength through</p>
              <div className="flex">
                <p className="italic">controlled</p>
                <p>&nbsp;movement.</p>
              </div>
            </div>
          </div>
      ...
      <section className="py-50 px-6 lg:px-10">
        ...
        >
          <p className="font-ivy-ora-display text-2xl px-1 md:max-w-4xl md:text-h2 tracking-wide md:leading-12">
            A low-impact practice that builds strength through controlled,
            supported movement. The resistance system allows for greater
            precision, helping improve
            <span className="italic">&nbsp;alignment</span> and
            <span className="italic">&nbsp;coordination</span>. Each session is
            adaptable, making it suitable for all levels.
          </p>
