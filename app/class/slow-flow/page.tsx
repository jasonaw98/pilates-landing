    ...
    <main className="min-h-screen">
      <section className="mt-32">
        <div className="flex flex-col items-center gap-12">
          ...
          <h1 className="text-4xl font-ivy-ora-display">Slow Flow Yoga</h1>
        </div>
      </section>
      <ClassZoomReveal
        image="/instructor/lior.jpg"
      ...
      <section className="py-50 px-6 lg:px-10">
        ...
        >
          <p className="font-ivy-ora-display text-2xl px-1 md:max-w-4xl md:text-4xl tracking-wide md:leading-12">
            ...
            <span className="italic">&nbsp;mobility</span>, it creates space for
            both effort and ease with each sequence.
          </p>
