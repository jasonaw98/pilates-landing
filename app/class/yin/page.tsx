    ...
    <main className="min-h-screen">
      <section className="mt-32">
        <div className="flex flex-col items-center gap-12">
          ...
          <h1 className="text-4xl font-ivy-ora-display md:text-h1">Yin Yoga</h1>
        </div>
      </section>
      <ClassZoomReveal
        image="/assets/mindful.png"
        bgPosition="object-[50%_100%] scale-[1]"
        content={
          <div className="max-w-5xl px-8 text-center text-white flex-col flex justify-between items-center h-full py-20 pt-32">
            <div className="text-2xl md:text-h1 h-full justify-center font-ivy-ora-display break-keep text-center items-center flex flex-col gap-2">
              <p>A slower practice for</p>
              <div className="flex">
                <p>release and&nbsp;</p>
                <p className="italic">stillness.</p>
              </div>
            </div>
          </div>
        }
      ...
      <section className="py-50 px-6 lg:px-10">
        ...
        >
          <p className="font-ivy-ora-display text-2xl px-1 md:max-w-4xl md:text-h2 tracking-wide md:leading-12">
            A slower, floor-based practice that targets deeper connective
            tissues through longer-held postures. It supports
            <span className="italic">&nbsp;flexibility</span> and
            <span className="italic">&nbsp;release</span> while encouraging
            stillness and a more inward, meditative awareness.
          </p>
