  ...
  return (
    <main>
      ...
      {isMobile ? (
        <div className="bg-[#3A1A12] px-6 pt-12 flex flex-col gap-8 border border-[#3A1A12]">
          ...
          <div className="flex gap-20">
            <div className="flex flex-col gap-1 text-white">
              ...
              <Link
                href="/"
                className="hover:text-taupe-500 transition-colors duration-300"
              >
                Home
              </Link>
              <Link
        ...
        <div className="bg-[#3A1A12] px-16 pt-12 flex flex-col gap-8 border border-[#3A1A12]">
          <div className="flex justify-between">
            ...
            <div>
              <div className="flex gap-20">
                <div className="flex flex-col gap-1 text-white">
                  <h1 className="font-nord text-white uppercase pb-2 font-bold">Menu</h1>
                  <Link
                    href="/"
              ...
              <p className="pt-8 text-white text-sm justify-self-end">Powered by BUTTERSOFT</p>
            </div>
          </div>
